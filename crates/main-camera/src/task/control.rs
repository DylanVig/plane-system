...
fn from_ptp_primitive<T: FromPrimitive>(ptp: &ptp::PtpData) -> Option<T> {
    match *ptp {
...
/// `FromPrimitive` (such as an enum).
fn convert_camera_value<T: FromPrimitive>(
